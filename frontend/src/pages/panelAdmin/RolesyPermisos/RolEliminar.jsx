...
export default function RolEliminar({ isOpen, onClose, onConfirm, role }) {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      >
        ...
        <div className="text-center mt-2">
          ...
          <h3 className="text-lg font-bold text-[#1A2C56] mb-2">¿Eliminar Rol?</h3>
          <p className="text-sm text-gray-600 mb-1">
            Esta acción eliminará permanentemente el rol{" "}
            <span className="font-semibold text-gray-800">{role.nombre}</span>.
          </p>
          <p className="text-sm text-gray-400">
            Los usuarios asociados podrían perder acceso a ciertas funciones.
          </p>
        </div>
