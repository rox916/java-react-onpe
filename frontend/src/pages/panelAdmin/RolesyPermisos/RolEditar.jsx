...
export default function RolEditar({ isOpen, onClose, onSave, role }) {
  ...
  // Actualiza los datos si cambia el rol seleccionado
  useEffect(() => {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      >
        ...
        <div className="flex justify-between items-center mb-4 border-b pb-2">
          <h2 className="text-lg font-bold text-[#1A2C56]">Editar Rol</h2>
          <button
            onClick={onClose}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-2">
              {allPermisos.map((permiso) => (
                ...
                >
                  <input
                    type="checkbox"
                    checked={formData.permisos?.includes(permiso) || false}
