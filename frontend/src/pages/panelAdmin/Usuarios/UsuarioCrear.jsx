...
export default function UsuarioCrear({ isOpen, onClose, onSave, roles, departamentos }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      {/* Fondo oscuro (sin cierre al hacer clic fuera) */}
      ...
      >
        ...
        <div className="flex justify-between items-center mb-4 border-b pb-2">
          <h2 className="text-lg font-bold text-[#1A2C56]">Crear Nuevo Usuario</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-gray-700">
          ...
          <Select label="Rol" name="rol" value={formData.rol} onChange={handleChange} options={roles} />
          <Select
            label="Departamento"
            name="departamento"
