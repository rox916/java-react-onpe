...
export default function CandidatoEliminar({ isOpen, onClose, onConfirm, candidate }) {
      ...
      >
        ...
        <div className="text-center mt-2">
          ...
          <p className="text-sm text-gray-600 mb-1">
            Esta acción eliminará permanentemente al candidato{" "}
            <span className="font-semibold text-gray-800">{candidate.nombre}</span>.
          </p>
